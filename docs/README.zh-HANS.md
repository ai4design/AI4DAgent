...
使用AI4DAgent的最简单方法是自动设置CLI，该CLI与项目捆绑在一起。
cli为AI4DAgent设置了以下内容：
- 🔐 [Environment variables](https://github.com/reworkd/AI4DAgent/blob/main/.env.example) (和 API 密钥)
...
<p align="center">
加入我们，共同推动AI4DAgent的发展，这是一个突破人工智能代理边界的开源项目！您的赞助将通过帮助我们扩大资源、增强功能和继续迭代这个令人兴奋的项目来推动进步！🚀
</p>
