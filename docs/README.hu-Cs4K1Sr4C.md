<p align="center">
  <img src="https://raw.githubusercontent.com/reworkd/AI4DAgent/main/public/banner.png?token=GHSAT0AAAAAAB7JND3U3VGGF3UYYHGYO4RAZBSDJAQ" height="300"/>
</p>
<p align="center">
...
<p align="center">
    <img alt="Node version" src="https://img.shields.io/static/v1?label=node&message=%20%3E=16.0.0&logo=node.js&color=2334D058" />
      <a href="https://github.com/reworkd/AI4DAgent/blob/master/README.md"><img src="https://img.shields.io/badge/lang-English-blue.svg" alt="English"></a>
  <a href="https://github.com/reworkd/AI4DAgent/blob/master/docs/README.zh-HANS.md"><img src="https://img.shields.io/badge/lang-简体中文-red.svg" alt="简体中文"></a>
  <a href="https://github.com/reworkd/AI4DAgent/blob/master/docs/README.hu-Cs4K1Sr4C.md"><img src="https://img.shields.io/badge/lang-Hungarian-red.svg" alt="Hungarian"></a>
</p>
...
Az AI4DAgent lehetővé teszi az automatizált AI-ügynökök konfigurálását és üzembe helyezését.
...
Az AI4DAgent helyi futtatásának legegyszerűbb módja a Docker használata.
...
- [Elágaztatás](https://github.com/reworkd/AI4DAgent/fork).

2. Klónozni a tárolót:

```bash
git clone git@github.com:YOU_USER/AI4DAgent.git
```
...
> 🚧 A környezeti változóknak meg kell egyeznie a következő [sémával](https://github.com/reworkd/AI4DAgent/blob/main/src/env/schema.mjs).
...
Állítsa be azonnal az AI4DAgent-t a felhőben a [GitHub Codespaces](https://github.com/features/codespaces) használatával.
...
- Az AI4DAgent leállításához írja be a Ctrl+C billentyűkombinációt a terminálba.
- Az AI4DAgent újraindításához futtassa az "npm run dev" parancsot a terminálban.
