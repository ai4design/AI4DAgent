---
title: Memory
description: Understanding how AI4DAgent manages memory with the help of vector databases.
icon: "brain"
---

# Memory Management in AI4DAgent
...
1. Weaviate is open-source and conveniently accessible via docker-compose, eliminating the need for an API key for local AI4DAgent runs.
