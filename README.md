<p align="center">
  <img src="https://raw.githubusercontent.com/reworkd/AI4DAgent/main/next/public/banner.png" height="300" alt="AI4DAgent Logo"/>
</p>
<p align="center">
...
AI4DAgent allows you to configure and deploy Autonomous AI agents.
...
[Demo Video](https://github.com/reworkd/AI4DAgent/assets/50181239/5348e44a-29a5-4280-a06b-fe1429a8d99e)


## 👨‍🚀 Getting Started

The easiest way to get started with AI4DAgent is automatic setup CLI bundled with the project.
The cli sets up the following for AI4DAgent:
- 🔐 [Environment variables](https://github.com/reworkd/AI4DAgent/blob/main/.env.example) (and API Keys)
- 🗂️ [Database](https://github.com/reworkd/AI4DAgent/tree/main/db) (Mysql)
- 🤖 [Backend](https://github.com/reworkd/AI4DAgent/tree/main/platform) (FastAPI)
- 🎨 [Frontend](https://github.com/reworkd/AI4DAgent/tree/main/next) (Nextjs)
...
3. **Clone the Repository and Navigate into the Directory** - Once your terminal is open, you can clone the repository and move into the directory by running the commands below.
   ...
   **For Mac/Linux users** :apple: :penguin:
   ```bash
   git clone https://github.com/reworkd/AI4DAgent.git
   cd AI4DAgent
   ./setup.sh
   ```
...
<p align="center">
Join us in fueling the development of AI4DAgent, an open-source project pushing the boundaries of AI agents! Your sponsorship would drive progress by helping us scale up resources, enhance features and functionality, and continue to iterate on this exciting project! 🚀
</p>
